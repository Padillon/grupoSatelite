...
ALTER TABLE `mxg_materiasxgrado`
  ...
  ADD KEY `mxg_id_grd` (`mxg_id_grd`,`mxg_id_mat`),
...
--
ALTER TABLE `grd_grado`
  MODIFY `grd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `alm_alumno`
  ADD CONSTRAINT `alm_alumno_ibfk_1` FOREIGN KEY (`alm_id_grd`) REFERENCES `grd_grado` (`grd_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `mxg_materiasxgrado`
--
ALTER TABLE `mxg_materiasxgrado`
  ADD CONSTRAINT `mxg_materiasxgrado_ibfk_1` FOREIGN KEY (`mxg_id_grd`) REFERENCES `grd_grado` (`grd_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mxg_materiasxgrado_ibfk_2` FOREIGN KEY (`mxg_id_mat`) REFERENCES `mat_materia` (`mat_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
